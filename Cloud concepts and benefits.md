...
High availability refers to a computing infrastructure that allows it to ***continue operating*** even if some of its components fail. So, depending on the service-level agreement (SLA) that a customer choose, they can experience a continuous user experience with no apparent downtime of cloud-based apps.
...
Scalability is the ability of the system to support desired workload.
...
Elasticity is the ability to scale automatically.
